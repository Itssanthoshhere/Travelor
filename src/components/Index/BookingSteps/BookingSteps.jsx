...
const BookingSteps = () => {
  return (
    <div className="px-[2%] sm:px-[8%] lg:px-[12%] py-[6%] md:py-[10%]">
      <div className="title flex flex-col justify-center items-center relative pb-10">
          ...
          {stepsData.map((step) => (
            ...
            >
              <div className="flex justify-between items-center gap-3">
                ...
                <div className="step-icon border-4 border-yellow rounded-full p-4">
              ...
              <div className="mt-5">
                ...
                <p className="text-gray-500 text-shadow-md tracking-wide">
                  {step.description}
                </p>
              </div>
            </div>

      ...
      <div className="booking px-[2%] sm:px-[8%] lg:px-[12%] py-[6%] md:py-[10%] relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10">
          <div className="step step-1 relative">
            ...
            <div className="step-content">
              ...
              <p className="font-medium text-white pb-5">
                All you have to do is, first select your preferred destination
                and proceed
              </p>
          ...
          <div className="step step-2 relative">
            <div className="step-icon mb-5 text-center">
              <div className="icon-back w-30 h-30 bg-[#ce8594] rounded-full inline-flex justify-center items-center">
                <div className="icon-front w-22.5 h-22.5 rounded-full bg-white inline-flex justify-center items-center shadow-2xl">
                  <img
                    src={step2img}
                    alt="step-img"
            ...
            <div className="step-content">
              ...
              <p className="font-medium text-white pb-5">
                You are important to us. We pay attention to the quality of
                every service we provide to you.
              </p>
          ...
          <div className="step step-3 relative">
            <div className="step-icon mb-5 text-center">
              <div className="icon-back w-30 h-30 bg-[#066168] rounded-full inline-flex justify-center items-center">
                <div className="icon-front w-22.5 h-22.5 rounded-full bg-white inline-flex justify-center items-center shadow-2xl">
                  <img
                    src={step3img}
                    alt="step-img"
            ...
            <div className="step-content">
              ...
              <p className="font-medium text-white pb-5">
                We have seen that you have fulfilled all the requirements, now

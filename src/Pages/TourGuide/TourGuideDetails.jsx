...
export default function TourGuideDetails() {
  ...
  if (!team) {
    return <div className="text-center mt-20">Teams Not Found</div>;
  }
        ...
        <div className="bg-white px-[2%] sm:px-[8%] py-[6%] md:py-[8%] rounded-2xl flex justify-between items-start gap-10 relative flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[70%] flex flex-col">
            ...
            <p className="text-md text-secondary/80 tracking-wide pb-5">
              ...
              individuals or groups through destinations, providing insightful
              commentary, logistical support, and cultural interpretation.
            ...
            <ul className="space-y-4 mb-5">
              <li className="flex items-center gap-2 text-gray-500/80 font-light">
                ...
                <div>
                  ...
                  Ministry of Tourism offers licenses via IITTM and regional
                  programs
                </div>
              </li>
              ...
              <li className="flex items-center gap-2 text-gray-500/80 font-light">
                ...
                <div>
                  ...
                  WFTGA (World Federation of Tourist Guide Associations) sets

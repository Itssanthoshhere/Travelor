            ...
            <ul className="space-y-5 pb-8">
              <li className="flex items-center flex-wrap gap-2">
                ...
                <span className="text-secondary font-light tracking-wide">
                  Explaining historical, cultural, and natural significance of
                  place
                </span>
              </li>
            ...
            <div className="service-table mb-8">
              <ul>
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      One-on-one personalized tours, often tailored to specific
                      interests
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Shared tours with multiple travelers, often more
                      budget-friendly
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Local experts for urban exploration—museums, markets,
                      monuments
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Focus on traditions, festivals, cuisine, and heritage
                      sites
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Oversee multi-day trips, handling logistics and group
                      coordination
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap border-0!">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Specialists in safaris, trekking, and eco-tourism areas
                      like sanctuaries
                    </p>
                  </div>
                </li>
            ...
            <div className="bg-[#fff8eb]! service-table overflow-hidden border-0! mb-8">
              <ul className="service-table3">
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Free Wi-Fi, toiletries, heated floors, in-room slippers,
                      cable TV, room service
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Free water & side dishes, call buttons, Wi-Fi, mobile
                      ordering
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Clean restrooms, free Wi-Fi (Seoul), tourist information
                      centers, lockers
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      High-speed KTX trains, T-money transportation cards,
                      mobile apps
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap border-b-0!">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Tax refund counters, delivery services, foreign language
                      staff (in major stores)
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-[#fff8eb]! service-table overflow-hidden border-0! mb-8">
              <ul className="service-table3">
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Korean breakfasts often include soup, rice, and side
                      dishes; Western options
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Many offer English menus, desserts, Korean snacks, and
                      unique drinks
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Apps like Baemin, Yogiyo offer English support and deliver
                      almost anywhere
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Growing availability, especially in Seoul; some apps help
                      locate vegan food
                    </p>
                  </div>
                </li>
                ...
                <li className="flex flex-wrap border-b-0!">
                  ...
                  <div className="content flex-1 py-3.75 px-7.5">
                    <p className="text-md text-secondary font-light tracking-wide">
                      Most Korean restaurants offer unlimited free side dishes
                      with meals
                    </p>
                  </div>
                </li>
          ...
          <div className="recent-posts bg-white p-3 lg:p-5 xl:p-10 mb-10">
            <div className="post1 relative flex py-5 border-b border-dashed border-secondary/50">
              <div className="post-date w-12 h-12 min-w-12 text-white bg-secondary flex flex-col justify-center items-center rounded-md">
                ...
                <span className="text-xs leading-none">June</span>
              </div>
            ...
            <div className="post2 relative flex py-5 border-b border-dashed border-secondary/50">
              <div className="post-date w-12 h-12 min-w-12 text-white bg-secondary flex flex-col justify-center items-center rounded-md">
                <span className="text-xl font-semibold leading-none">20</span>
            ...
            <div className="post3 relative flex py-5 border-b border-dashed border-secondary/50">
              <div className="post-date w-12 h-12 min-w-12 text-white bg-secondary flex flex-col justify-center items-center rounded-md">
                <span className="text-xl font-semibold leading-none">22</span>
